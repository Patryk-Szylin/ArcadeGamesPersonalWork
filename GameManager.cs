...
public class GameManager : NetworkBehaviour
{
    ...
    IEnumerator GameOver()
    {
        ...
        var winnerText = m_winner != null ? "Game Over \n " + m_winner.m_pSetup.m_playerName + " is the winner!" : "There are no winners this game";
        RpcUpdateMessage(winnerText); // Later add a text that announces a winner      
